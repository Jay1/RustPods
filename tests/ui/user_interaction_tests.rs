...
use iced::{keyboard, Event, Point, Rectangle};

use rustpods::ui::form_validation::FieldValidator;
use rustpods::ui::keyboard_shortcuts::{handle_events, KeyboardShortcut, KeyboardShortcutManager};
use rustpods::ui::window_management::{DragRegion, WindowInteraction};
...
fn test_combined_validators() {
    ...
    // Combine validators
    let combined_validator = FieldValidator::chain(vec![required_validator, range_validator]);
