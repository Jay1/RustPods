...
use crate::airpods::{detect_airpods, DetectedAirPods};
use crate::bluetooth::{AirPodsBatteryStatus, BleScanner};
...
impl App {
    ...
    pub async fn start_battery_monitoring_for_device(
        &mut self,
        airpods: &DetectedAirPods,
    ) -> Result<(), RustPodsError> {
    ...
    async fn get_peripheral_for_airpods(
        &self,
        airpods: &DetectedAirPods,
        ...
        match self
            .scanner
            .get_peripherals_by_address(&airpods.address)
            .await
        {
