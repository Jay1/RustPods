...
pub fn view(
    ...
    Column::new()
        ...
        .push({
            ...
            let mut icon_row = Row::new().align_items(Alignment::Center).push(
            ...
            if is_charging {
                icon_row = icon_row.push(
                    Svg::new(iced::widget::svg::Handle::from_memory(
                        crate::assets::ui::CHARGING_ICON,
                    ))
...
fn battery_icon_svg_string(percentage: f32, charging: bool, color: &str) -> String {
    ...
    if p > 0.01 {
        write!(
            ...
            fill_area_x, fill_y_position, fill_area_width, actual_fill_height, color
        )
        .unwrap();
    }
