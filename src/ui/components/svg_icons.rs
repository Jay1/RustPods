...
pub fn refresh_icon_svg_string(animated: bool, progress: f32) -> String {
    ...
    let rotation = if animated { progress * 360.0 } else { 0.0 };
...
pub fn settings_icon_svg_string(color: Color) -> String {
    ...
    write!(
        &mut svg_string,
        r#"<circle cx='12' cy='12' r='3.5' stroke='{}' stroke-width='2' fill='{}'/>"#,
        hex, hex
    )
    .unwrap();
...
pub fn headset_icon_svg_string() -> String {
    ...
    write!(
        &mut svg_string,
        r#"<rect x='4' y='20' width='6' height='8' rx='2' fill='currentColor'/>"#
    )
    .unwrap();
    // Right earcup
    write!(
        &mut svg_string,
        r#"<rect x='22' y='20' width='6' height='8' rx='2' fill='currentColor'/>"#
    )
    .unwrap();
    // Mic (optional, subtle)
